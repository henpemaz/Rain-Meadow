...
namespace RainMeadow
{
    public class StoryOnlineMenu : SlugcatSelectMenu
    {
        ...
        public override void Update()
        {
            ...
            chatScroller.InputScrollEnabled = this.isChatToggled;
        ...
        public override void ShutDownProcess()
        {
            ...
            ChatTextBox.OnShutDownRequest -= ResetChatInput;
            ChatLogManager.Unsubscribe(chatScroller);
        ...
        private void SetupOnlineMenuItems()
        {
            ...
            chatScroller = new(this, pages[0], new(chatTextBoxPos.x, 330 - maxVisibleMessages * 20), new(manager.rainWorld.screenSize.x / 2.7f, maxVisibleMessages * 20))
            {
                buttonHeight = 20,
            ...
            ChatLogManager.Subscribe(chatScroller);
