    ...
    {     
        private ValueTuple<string, string> GetDescription()
        {
            ...
            else if (slugcatNumber == SlugcatStats.Name.Red)
            {
                ...
                {
                    subText = "Strong and quick, with a fierce metabolism requiring a steady diet of meat. But the<LINE>stomach won't be your only concern, as the path of the hunter is one of extreme peril.";
                }
            }
