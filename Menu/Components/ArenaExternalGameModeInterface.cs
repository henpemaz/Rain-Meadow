...
namespace RainMeadow.UI.Components
{
    public class OnlineArenaExternalGameModeSettingsInterface : PositionedMenuObject, CheckBox.IOwnCheckBox, MultipleChoiceArray.IOwnMultipleChoiceArray
    {
        ...
        public OnlineArenaExternalGameModeSettingsInterface(ArenaOnlineGameMode arena, Menu.Menu menu, MenuObject owner, Vector2 pos, float settingsWidth = 300) : base(menu, owner, pos)
        {
