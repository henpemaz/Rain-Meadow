...
namespace RainMeadow.UI.Components
{
    public class ArenaPlayerSmallBox : RectangularMenuObject, ButtonScroller.IPartOfButtonScroller
    {
        ...
        public ArenaPlayerSmallBox(Menu.Menu menu, MenuObject owner, OnlinePlayer player, bool canKick, Vector2 pos, Vector2 size = default) : base(menu, owner, pos, size == default? DefaultSize : size)
        {
            ...
            slugcatButton = new(menu, this, "", new(playerButton.pos.x + playerButton.size.x + 15, yPos), new(120, 30));
            InitButtons(canKick);
        ...
        public override void GrafUpdate(float timeStacker)
        {
            ...
            playerButton.rectColor = baseCol;
            slugcatButton.rectColor = baseCol;
            slugcatButton.menuLabel.text = SlugcatStats.getSlugcatName(slugcat);
        }
        ...
        public ButtonScroller.ScrollerButton slugcatButton, playerButton;
