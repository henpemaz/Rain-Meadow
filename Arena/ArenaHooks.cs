...
namespace RainMeadow
{
    public partial class RainMeadow
    {
        ...
        private void ArenaHooks()
        {
            ...
            On.HUD.TextPrompt.AddMessage_string_int_int_bool_bool += Drown_TextPrompt_AddMessage_string_int_int_bool_bool;
            On.Spear.Spear_makeNeedle += Drown_Spear_Spear_makeNeedle;
            IL.Player.ClassMechanicsSaint += Drown_Player_ClassMechanicsSaint;
            On.Player.checkInput += Drown_Player_checkInput;
        ...
        private bool ArenaGameSession_ShouldSessionEnd(On.ArenaGameSession.orig_ShouldSessionEnd orig, ArenaGameSession self)
        {
            ...
            return arena.externalArenaGameMode.ShouldSessionEnd(arena, orig,self);

        }

        // BEGIN Drown //
        private void Drown_Player_checkInput(On.Player.orig_checkInput orig, Player self)
        {
            orig(self);
        ...
        private void Drown_Player_ClassMechanicsSaint(ILContext il)
        {
        ...
        private void Drown_Spear_Spear_makeNeedle(On.Spear.orig_Spear_makeNeedle orig, Spear self, int type, bool active)
        {
        ...
        private void Drown_TextPrompt_AddMessage_string_int_int_bool_bool(On.HUD.TextPrompt.orig_AddMessage_string_int_int_bool_bool orig, HUD.TextPrompt self, string text, int wait, int time, bool darken, bool hideHud)
        {
            ...
            {
                text = text + $" - Press {rainMeadowOptions.OpenStore.Value} to access the store";
        ...
        private int ArenaGameSession_PlayersStillActive(On.ArenaGameSession.orig_PlayersStillActive orig, ArenaGameSession self, bool addToAliveTime, bool dontCountSandboxLosers)
        {
            if (isArenaMode(out var arena))
            {
               return arena.externalArenaGameMode.PlayersStillActive(arena, orig, self, addToAliveTime, dontCountSandboxLosers);
            } else
            {
