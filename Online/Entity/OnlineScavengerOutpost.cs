...
namespace RainMeadow
{
    public class OnlineScavengerOutpost : OnlineEntity
    {
        ...
        public class ScavengerOutpostDefinition : EntityDefinition
        {
            [OnlineField]
            protected int index;

            public ScavengerOutpostDefinition() { }
            public ScavengerOutpostDefinition(OnlineScavengerOutpost oso, OnlineResource inResource) : base(oso, inResource)
            {
                index = 0;
            ...
            {
                return new OnlineScavengerOutpost(this, inResource, (ScavengerOutpostState)initialState);
            }
        ...
        public OnlineScavengerOutpost(ScavengerOutpostDefinition entityDefinition, OnlineResource inResource, ScavengerOutpostState initialState) : base(entityDefinition, inResource, initialState)
        {
        ...
        {
            return new ScavengerOutpostDefinition(this, onlineResource);
        }
        ...
        public class ScavengerOutpostState : EntityState
        {
            [OnlineField]
            PearlStringState[] pearlStrings;

            public ScavengerOutpostState() { }
            public ScavengerOutpostState(OnlineScavengerOutpost onlineScavengerOutpost, OnlineResource inResource, uint ts) : base(onlineScavengerOutpost, inResource, ts)
            {
        ...
        {
            return new ScavengerOutpostState(this, inResource, tick);
        }
