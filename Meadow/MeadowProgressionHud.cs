...
namespace RainMeadow
{
    public class MeadowProgressionHud : HudPart
    {
        ...
        public MeadowProgressionHud(HUD.HUD hud) : base(hud)
        {
            ...
            emotesIcon = SpecialEvents.IsSpecialEventInLobby ? new MeadowCoinIcon(progressionContainer, MeadowProgression.TokenRedColor, DrawPos(1f, 0), 0.05f, 1f)  : new TokenSparkIcon(progressionContainer, MeadowProgression.TokenRedColor, DrawPos(1f, 0), 1.5f, 1f);
            ...
            skinsIcon = SpecialEvents.IsSpecialEventInLobby ? new MeadowCoinIcon(progressionContainer, MeadowProgression.TokenBlueColor, DrawPos(1f, 1),  0.05f, 1f)  :  new TokenSparkIcon(progressionContainer, MeadowProgression.TokenBlueColor, DrawPos(1f, 1), 1.5f, 1f);
            ...
            characterIcon = SpecialEvents.IsSpecialEventInLobby ? new MeadowCoinIcon(progressionContainer,MeadowProgression.TokenGoldColor, DrawPos(1f, 2), 0.05f, 1f) :  new TokenSparkIcon(progressionContainer, MeadowProgression.TokenGoldColor, DrawPos(1f, 2), 1.5f, 1f);
