...
namespace RainMeadow
{
    public class HolidayStoreOverlay : Menu.Menu
    {
        ...
        public class ItemButton
        {
            ...
            public ItemButton(HolidayStoreOverlay menu, AbstractCreature me, Vector2 pos, RainWorldGame game, KeyValuePair<string, int> itemEntry, int index, bool canBuy = false)
            {
                    this.overlay = menu;
                    ...
                    this.button.OnClick += (_) =>
                    {
                        ...
                        if (desiredObject != null && me != null)
                        {
                            ...
                            HolidayEvents.SpentMeadowCoin(true, itemEntry.Value);
                        }
                        didRespawn = false;
        ...
        public HolidayStoreOverlay(ProcessManager manager, RainWorldGame game) : base(manager, RainMeadow.Ext_ProcessID.SpectatorMode)
        {
            this.game = game;
            ...
            this.pages[0].subObjects.Add(new Menu.MenuLabel(this, this.pages[0], this.Translate("STORE"), new Vector2(pos.x, 553), new Vector2(110, 30), true));
            ...
            {
                if (OnlinePhysicalObject.map.TryGetValue(game.Players[i], out var onlineP) && onlineP.owner == OnlineManager.mePlayer)
                {
                    me = game.Players[i];
                    break;
                }
        ...
        public override void Update()
        {
            ...
            {
                storeItemList[i].button.buttonBehav.greyedOut = me != null ? RainMeadow.rainMeadowOptions.MeadowCoins.Value < storeItemList[i].cost : me == null;
            }
        }
    }
}